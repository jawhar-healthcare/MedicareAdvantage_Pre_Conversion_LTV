...
def get_jornaya_data(
    ...
    irrelevant_features = [
        ...
        "jrn_request_age",
        "jrn_boberdoo_product",
        "jrn_boberdoo_tcpa_universal_id",
    ...
    irrelevant_features = irrelevant_features + [z for z in jornaya.columns if "zip" in z.lower()]
    jornaya.drop(columns= irrelevant_features, inplace= True)
...
def preprocess_transunion_data(
    ...
    irrelevant_features = [
        ...
        "tu_DOB",
        "tu_VERIFY_INPUT",
        "tu_VERIFY_FIRST_NAME",	
        "tu_VERIFY_LAST_NAME",	
        "tu_VERIFY_ADDRESS",
        "tu_VERIFY_DOB", 
        "tu_VERIFY_PHONE_NUMBER",
        "tu_VERIFY_EMAIL",
        "tu_DEMO_AGE_YEARS",
        "tu_DEMO_AGE_MATCH",
        "tu_ADDRESS",
    ...
    ## Remove any zipcode 
    irrelevant_features = irrelevant_features + [z for z in trunc_tu_data.columns if "zip" in z.lower()]

    trunc_tu_data.drop(columns= irrelevant_features, inplace= True)
